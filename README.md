...
blockchain that saves time by having 3 randos verifying instead of everyone
...
* Uses my https://github.com/compromise-evident/rolling-code
  to generate 512 pseudorandom keys that are 1,000 characters each.
  The characters are 33 to 126.

* A ciphertext (encrypted item) is the SHA-512 hash of a key.
